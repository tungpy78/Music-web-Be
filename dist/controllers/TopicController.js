...
const create = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!title || !((_b = files === null || files === void 0 ? void 0 : files.fileAvata) === null || _b === void 0 ? void 0 : _b.length)) {
            res.status(400).json({ message: 'Thiếu trường bắt buộc: title, avatar' + ((_c = files === null || files === void 0 ? void 0 : files.fileAvata) === null || _c === void 0 ? void 0 : _c.length), });
            return;
        }
        const topicRequest = {
            title,
