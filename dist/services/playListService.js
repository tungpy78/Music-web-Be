...
const getPlayListByIdService = (playlistId) => __awaiter(void 0, void 0, void 0, function* () {
    const playlistdetail = yield Playlist_model_1.default.findById(playlistId)
        .populate({
        path: 'songs.songId',
        populate: {
            path: 'artist',
