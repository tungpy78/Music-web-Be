...
router.post('/create', topic_validator_1.topicValidators.createTopic, upload_1.default.fields([{ name: 'fileAvata', maxCount: 1 }]), TopicController_1.TopicController.create);
